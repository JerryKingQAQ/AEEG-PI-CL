...
class CifarResNet(nn.Module):
    ...
    def __init__(self, block, depth, channels=32):
        ...
        self.avgpool_1 = nn.AvgPool2d(kernel_size=2,stride=(47, 1))
        self.avgpool_2 = nn.AvgPool2d(kernel_size=1,stride=(2, 1))
    ...
    def forward(self, x):
        ...
        pooled = self.avgpool_1(x_3)  # [bs, 64, 1, 1]
        pooled = self.avgpool_2(pooled)  # [bs, 64, 1, 1]
